 ...
 */
function orbisius_ct_goplex_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ct_goplex_parent_style';
    $parent_base_dir = 'jumpstart';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_goplex_child_theme_enqueue_styles' );
